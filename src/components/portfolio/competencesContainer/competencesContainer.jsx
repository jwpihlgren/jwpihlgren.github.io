...
function CompetenceContainer(props) {
    ...
    return (
      ...
      {/* <section style={{margin: "0 auto", maxWidth: "65%"}}className={styles.centered} id={props.title} ref={props.getRef}>  */}
      <section className={styles.centered} id={props.title} ref={props.getRef}> {/* Temporary inline-css, potential bug keeps rule from being applied in production */}
